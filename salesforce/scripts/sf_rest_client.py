...
class SalesforceRESTClient:
    ...
    def _request(self, method, endpoint, data=None, params=None):
        ...
        Returns:
            dict or None: Response JSON, or None for 204 responses.
        """
        ...
        if response.status_code in (200, 201):
            ...
            return None  # Success, no content (update/delete)
        else:
    ...
    def create(self, sobject, data):
        ...
        Args:
            sobject: Object API name (e.g., 'Account', 'Contact')
    ...
    def read(self, sobject, record_id, fields=None):
        ...
        return self._request(
            "GET", f"/sobjects/{sobject}/{record_id}", params=params
        )
    ...
    def query_all(self, soql):
        """
        Execute a SOQL query with auto-pagination (fetches ALL records).
        ...
        while not result.get("done", True):
            ...
            # nextRecordsUrl is relative to instance_url, not base_url
    ...
    def composite(self, requests_list, all_or_none=True):
        ...
        Args:
            requests_list: List of composite request dicts
            all_or_none: If True, all succeed or all fail

        Returns:
            dict: Composite response.
        """
        data = {
...
if __name__ == "__main__":
    ...
    # Example: Describe Account object
    # desc = client.describe_object("Account")
    # print(f"Account has {len(desc['fields'])} fields")
