...
class SalesforceAuth:
    ...
    def authenticate(self):
        ...
        Returns:
            dict: Contains 'access_token', 'instance_url', 'id', 'token_type', etc.
    ...
    def authenticate_simple(self):
        ...
        Returns:
            dict: Contains 'access_token' (sessionId) and 'instance_url'.
        """
...
if __name__ == "__main__":
    ...
    # Use SOAP login (works without Connected App)
